...
from nDiffusion.src.process_Inputs_v2 import *
...
class nDiffusion():
    ...
    def __init__(self, network, graph_gene, gl1, gl1_name, gl2, gl2_name, output):
        ...
        GP1_only_dict, GP2_only_dict, overlap_dict, other_dict = parseGeneInput(self.geneList1_fl, self.geneList2_fl, self.group1_name, self.group2_name, graph_node, graph_node_index, node_degree, self.graph_gene)
